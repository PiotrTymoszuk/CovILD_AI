...
Differences in median of the CT parameters between observations with and without a LFT abnormality were investigated with blocked bootstrap test with biserial r effect size statistic (H0: no difference in CT parameter, H1: CT parameter values are higher in observations with the LFT abnormality). 
